...
//定义APP全局主题tint color
#define GLOBALTINTCOLOR [UIColor colorWithRed:89/255.0 green:217/255.0 blue:247/255.0 alpha:1.0]
//屏幕宽度
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    if([self.currentYearAndMonth isEqualToString:@""])
    {
        //如果第一次打开月份选择器，则显示当前年月
    ...
    {
        //否则从文本标签获取已选择的年月
        year = [self.currentYearAndMonth substringWithRange:NSMakeRange(0, 4)];
        month = [self.currentYearAndMonth substringWithRange:NSMakeRange(5, 2)];
    }
